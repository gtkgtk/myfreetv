package org.rom.myfreetv.view.VText;
import java.awt.*;
import java.lang.*;
import javax.swing.*;
 ...
 *
 * Ce module a été réalisé à partir du travail de Lee Ann Rucker :
...
public class CompositeIcon implements Icon, SwingConstants {
    ...
    */
   public void paintIcon(Component c, Graphics m_g, int x, int y) {
      Graphics2D g = (Graphics2D) m_g;
   ...
   public int getIconWidth() {
       ...
       */
      // code provisoire pour eviter le pb de la taille des onglets (trop grand)
      return 5;
   }
